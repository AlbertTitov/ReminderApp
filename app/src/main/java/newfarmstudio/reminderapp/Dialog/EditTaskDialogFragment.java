package newfarmstudio.reminderapp.Dialog;
...
public class EditTaskDialogFragment extends DialogFragment {
    ...
    public static EditTaskDialogFragment newInstance (ModelTask modelTask) {
        ...
        args.putLong("time_stamp", modelTask.getTimeStamp());
    ...
    public void onAttach(Context context) {
        ...
        try {
            editingTaskListener = (EditingTaskListener) getActivity();

        } catch (ClassCastException e) {

            throw new ClassCastException(getActivity().toString() + " must implement EditingTaskListener");
        }
    }
